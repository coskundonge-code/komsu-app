...
const blogArticles: Record<string, any> = {
  'mahallede-guvenlik-nasil-artirabiliriz': {
    ...
    author: {
      ...
      bio: 'Ayşe Kaya, 15 yıldan fazla mahalle güvenliği ve topluluk geliştirme alanında çalışmıştır. Mahallemiz güvenlik inisiyatifinin kurucu üyesidir.',
    },
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'Mahallemiz kullanarak, bulunduğunuz mahallede birbiriyle tanışan bir topluluk oluşturabilirsiniz. Platform aracılığıyla etkinlik planlamak, mesaj paylaşmak ve birbirlerinize yardım etmek çok daha kolaydır.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        text: 'Etkili bir iletişim ağı, mahalle güvenliğinin temel taşıdır. Mahallemiz gibi dijital platformlar, bu ağları kurmanın en etkili yollarından biridir. Platform üzerinden şüpheli aktiviteler, güvenlik tehditleri veya acil durumlar hakkında uyarı yaymak çok hızlıdır.',
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'paragraph',
        text: 'Mahalle güvenliği, tüm sakinlerin katılımı ve işbirliği ile oluşturulur. Komşularınızı tanıyın, iletişim halinde kalın, acil durum planları hazırlayın ve birbirlerinizi destekleyin. Mahallemiz gibi araçlar bu süreci kolaylaştırır ve daha güvenli, daha samimi mahalleler oluşturmanıza yardımcı olur.',
      },
      {
        type: 'paragraph',
  ...
  'mahallem-topluluk-yonetimi': {
    ...
    author: {
      ...
      bio: 'Mehmet Demir, 8 yıldan beri online topluluk yönetimi konusunda uzmanlaşmıştır. Türkiye\'nin en aktif Mahallemiz topluluk yöneticilerinden biridir.',
    },
    ...
    content: [
      {
        type: 'paragraph',
        text: 'Bir mahalle topluluğu yönetmek, kişilik, sabır ve tutarlı stratejiye ihtiyaç duyar. Mahallemiz üzerinde başarılı bir topluluk oluşturmak istiyorsanız, bu yazıdaki ipuçlarını uygulayabilirsiniz.',
      },
      {
        type: 'heading',
  ...
  'yerel-isletmecilerin-basari-hikayeleri': {
    ...
    content: [
      {
        type: 'paragraph',
        text: 'Cihangir Mahallesinin kalbinde 30 yıldır hizmet veren Gül Bakkalı\'nın sahibi Gül Hanım, Mahallemiz sayesinde işletmesini tamamen değiştirdi.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        text: 'Başlangıçta dijital platformlara şüpheli olan Gül Hanım, torununun teşvikiyle Mahallemiz\'ta bir sayfa açmaya karar verdi. Bulunduğu mahalledeki mahallelerini takip eden müşteriler kendisine mensaj göndererek sipariş vermek istediler.',
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'paragraph',
        text: 'Bugün Gül Bakkalı, mahallede en popüler bakkallarından biri. Müşterileri Mahallemiz\'ta onu takip ediyor, yeni ürünleri merakla bekliyorlar ve ona tavsiye ediyorlar. Gül Hanım da mahallede daha iyi tanınıyor ve işletmesine daha çok müşteri kazanıyor.',
      },
      {
        type: 'paragraph',
...
const allArticles = [
  ...
  },
  {
    ...
    slug: 'yerel-isletmecilerin-basari-hikayeleri',
    title: 'Yerel İşletmecilerin Başarı Hikayeleri',
    excerpt: 'Cihangir Mahallesinde işletmesini Mahallemiz sayesinde nasıl büyüttüğünü öğrenin.',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 lg:py-12">
        ...
        <section className="mt-16 p-8 md:p-12 bg-gradient-to-br from-[#00833e] to-[#006b32] rounded-lg text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Mahallemiz Topluluğuna Katılın
          </h2>
