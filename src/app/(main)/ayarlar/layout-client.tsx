    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-surface border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link href="/" className="flex items-center gap-2 text-primary hover:text-primary-hover font-semibold mb-4">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-3 px-4 py-4 border-l-4 transition-colors ${
                        isActive
                          ? 'bg-primary-light border-l-primary text-primary'
            ...
            <div className="mt-8 bg-surface rounded-lg shadow-md p-6">
              ...
              <button className="w-full px-4 py-2 border border-primary text-primary rounded-lg font-medium hover:bg-primary-light transition-colors">
                Yardım Merkezi
              </button>
            </div>
          </div>
