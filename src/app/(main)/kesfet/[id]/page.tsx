...
const mockNewsDetail: Record<string, {
  ...
  '1': {
    ...
    time: '2 saat önce',
    category: 'İşletmeler',
    thumbnail: 'https://images.unsplash.com/photo-1521017713117-d52e7b7e8c5d?w=800&h=400&fit=crop',
    author: 'Editör',
    readTime: '3 dk okuma',
  },
  '2': {
    ...
    time: '4 saat önce',
    category: 'Belediye',
    thumbnail: 'https://images.unsplash.com/photo-1535678057203-ef71b8f8b21e?w=800&h=400&fit=crop',
