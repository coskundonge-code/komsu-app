...
const mockEvents: Event[] = [
  {
    ...
    coverImage: 'https://picsum.photos/500/350?random=100',
    isInterested: false,
    category: 'social',
    interestedCount: 31,
    attendees: 28,
    organizerName: 'Ayşe Demir',
    organizerImage: 'https://picsum.photos/40/40?random=1',
  },
  {
    id: '2',
    ...
    coverImage: 'https://picsum.photos/500/350?random=101',
    isInterested: true,
    category: 'sports',
    interestedCount: 42,
    attendees: 38,
    organizerName: 'Zeynep Yıldız',
    organizerImage: 'https://picsum.photos/40/40?random=2',
  },
  {
    id: '3',
    ...
    time: '19:30',
    location: 'Çevrimiçi',
    coverImage: 'https://picsum.photos/500/350?random=102',
    isInterested: false,
    category: 'culture',
    interestedCount: 18,
    attendees: 15,
    organizerName: 'Murat Kaya',
    organizerImage: 'https://picsum.photos/40/40?random=3',
    isOnline: true,
  },
  {
    id: '4',
    ...
    time: '14:00',
    location: 'Moda Parkı',
    coverImage: 'https://picsum.photos/500/350?random=103',
    isInterested: false,
    category: 'social',
    interestedCount: 45,
    attendees: 42,
    organizerName: 'Fatma Erdoğan',
    organizerImage: 'https://picsum.photos/40/40?random=4',
  },
  {
    id: '5',
    ...
    coverImage: 'https://picsum.photos/500/350?random=104',
    isInterested: true,
    category: 'education',
    interestedCount: 28,
    attendees: 24,
    organizerName: 'Hasan Güzel',
    organizerImage: 'https://picsum.photos/40/40?random=5',
  },
  {
    id: '6',
    ...
    time: '18:00',
    location: 'Spor Alanı',
    coverImage: 'https://picsum.photos/500/350?random=105',
    isInterested: false,
    category: 'sports',
    interestedCount: 56,
    attendees: 50,
    organizerName: 'Ali Çetin',
    organizerImage: 'https://picsum.photos/40/40?random=6',
  },
  {
    id: '7',
    ...
    coverImage: 'https://picsum.photos/500/350?random=106',
    isInterested: false,
    category: 'music',
    interestedCount: 67,
    attendees: 60,
    organizerName: 'Selin Korkmaz',
    organizerImage: 'https://picsum.photos/40/40?random=7',
  },
  {
    id: '8',
    ...
    coverImage: 'https://picsum.photos/500/350?random=107',
    isInterested: false,
    category: 'social',
    interestedCount: 32,
    attendees: 30,
    organizerName: 'Gül Şahin',
    organizerImage: 'https://picsum.photos/40/40?random=8',
  },
];
