...
export default function UseReferralPage() {
    ...
    return (
      <div className="min-h-screen bg-[#f0f2f5] py-12 px-4">
        <div className="max-w-lg mx-auto">
          <div className="bg-white rounded-2xl border border-[#e0e0e0] p-8 text-center shadow-sm">
            ...
            <h1 className="text-2xl font-bold text-[#333] mb-3">Tebrikler! Doğrulandınız</h1>
            ...
            <p className="text-sm text-[#8f8f8f] mb-6">
              Adres doğrulaması yapmanıza gerek kalmadı. Tüm KomşuApp özelliklerini kullanabilirsiniz.
            </p>
            <div className="bg-[#e6f4ec] border border-[#00833e] rounded-lg p-4 mb-6">
              <div className="flex items-center gap-3">
                <Shield className="w-6 h-6 text-[#00833e]" />
                <div className="text-left">
                  <p className="font-semibold text-[#00833e] text-sm">Referansla Doğrulanmış Komşu</p>
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] py-8 px-4">
      <div className="max-w-lg mx-auto">
        {/* Back Link */}
        <Link href="/" className="text-[#00833e] hover:text-[#006b32] font-medium mb-6 inline-flex items-center gap-2">
          <ArrowLeft className="w-4 h-4" />
          Ana Sayfaya Dön
        </Link>

        {/* Header */}
        <div className="bg-white rounded-2xl border border-[#e0e0e0] p-8 shadow-sm mb-6">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <UserPlus className="w-8 h-8 text-blue-600" />
            </div>
            <h1 className="text-2xl font-bold text-[#333] mb-2">Referans Kodu Kullan</h1>
            <p className="text-[#666]">
              Komşunuzdan aldığınız referans kodunu girin ve adres doğrulama adımını atlayarak hemen KomşuApp&apos;ı kullanmaya başlayın.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="referral-code" className="block text-sm font-semibold text-[#333] mb-2">
                Referans Kodu
              </label>
              <input
                id="referral-code"
                ...
                className={`w-full px-4 py-3.5 border-2 rounded-xl text-lg font-mono tracking-widest text-center focus:outline-none transition-colors ${
                  status === 'error'
                    ...
                    : 'border-[#e0e0e0] focus:border-[#00833e] bg-[#f9f9f9] focus:bg-white'
                }`}
                maxLength={15}
                autoComplete="off"
              />
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-[#e0e0e0] p-5">
            <h3 className="font-semibold text-[#333] mb-2">Referans kodu nedir?</h3>
            <p className="text-sm text-[#666]">
              KomşuApp&apos;taki mevcut bir komşunuzun size verdiği özel koddur. Bu kod ile adres doğrulama adımını atlar, hemen sisteme dahil olursunuz.
            </p>
          </div>

          <div className="bg-white rounded-xl border border-[#e0e0e0] p-5">
            <h3 className="font-semibold text-[#333] mb-2">Referans kodum yok, ne yapmalıyım?</h3>
          ...
          <div className="bg-white rounded-xl border border-[#e0e0e0] p-5">
            <h3 className="font-semibold text-[#333] mb-2">Doğrulandıktan sonra ne olur?</h3>
            <p className="text-sm text-[#666]">
