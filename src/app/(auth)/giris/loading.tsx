...
export default function LoginLoading() {
  return (
    <div className="flex min-h-screen bg-[#f0f2f5]">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#00833e] to-[#005e2c] items-center justify-center p-12">
          ...
          <div className="bg-white rounded-lg border border-[#e0e0e0] p-6 space-y-4">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm">
                <Skeleton className="w-12 h-4 rounded bg-white" />
              </div>
            </div>
