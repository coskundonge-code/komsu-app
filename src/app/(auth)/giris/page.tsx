...
export default function GirisPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authError) {
        setError(authError.message === 'Invalid login credentials' ? 'E-mail veya şifre hatalı' : authError.message)
        return
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-2xl font-bold text-gray-900">KomşuApp</h1>
        <p className="text-gray-600 text-sm">Mahallenize hoş geldiniz</p>
      </div>
