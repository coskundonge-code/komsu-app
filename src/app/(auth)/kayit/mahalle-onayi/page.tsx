      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center py-12 px-6 sm:px-8 lg:px-12 bg-[#f8fafb] overflow-y-auto">
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between gap-2 mb-3">
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <span className="text-xs text-[#333] font-semibold text-center">Mahalle</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-[#333] mb-2">Mahalleyi Onaylayın</h2>
            <p className="text-[#8f8f8f] text-sm">Bulunduğunuz mahalle bu mu?</p>
          </div>
          ...
          <div className="bg-white border border-[#e0e0e0] rounded-xl overflow-hidden mb-6">
            ...
            <div className="p-6">
              <div className="mb-4">
                <h3 className="text-2xl font-bold text-[#333] mb-1">{selectedNeighborhood.name}</h3>
              ...
              {/* Stats Grid */}
              <div className="grid grid-cols-3 gap-4 py-4 border-t border-b border-[#e0e0e0]">
                {/* Members */}
                <div className="text-center">
                  ...
                  <p className="text-xs text-[#8f8f8f]">Mahalle Üyesi</p>
                </div>

                {/* Active Posts */}
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <MessageSquare className="w-4 h-4 text-[#00833e]" />
                    <span className="text-lg font-bold text-[#333]">{selectedNeighborhood.activePosts}</span>
                  </div>
                  <p className="text-xs text-[#8f8f8f]">Aktif Konu</p>
                </div>

                {/* Nearby Businesses */}
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    <svg className="w-4 h-4 text-[#00833e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    <span className="text-lg font-bold text-[#333]">{selectedNeighborhood.nearbyBusinesses}</span>
                  </div>
                  <p className="text-xs text-[#8f8f8f]">Yakın İşletme</p>
                </div>
              </div>

              {/* Welcome Message */}
              <div className="mt-4 p-4 bg-[#e6f4ec] rounded-lg border border-[#a7dbb8]">
          ...
          <form onSubmit={handleConfirm} className="space-y-4">
            ...
            <div className="flex items-start gap-3 p-4 bg-[#f0f2f5] rounded-lg">
              ...
              />
              <label htmlFor="confirm" className="text-sm text-[#333] cursor-pointer flex-1">
            ...
            <button
              ...
              className="w-full bg-[#00833e] hover:bg-[#006b32] text-white font-semibold py-3 rounded-xl text-sm transition disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md flex items-center justify-center gap-2 mb-3"
            >
            ...
            <button
              ...
              className="w-full bg-white border border-[#e0e0e0] text-[#333] font-semibold py-3 rounded-xl text-sm hover:bg-[#f0f2f5] transition flex items-center justify-center gap-2"
            >
              <MapPin className="w-4 h-4" />
              Farklı Mahalle Seç
            </button>
          ...
          <div className="mt-8 pt-6 border-t border-[#e0e0e0] text-center">
            <Link href="/kayit/adres-dogrulama" className="text-sm text-[#00833e] hover:text-[#006b32] font-semibold transition inline-flex items-center gap-1">
              <span>← Geri dön</span>
            </Link>
          </div>
        </div>
