    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center py-12 px-6 sm:px-8 lg:px-12 bg-[#f8fafb]">
        <div className="w-full max-w-sm mx-auto">
          ...
          {/* Success Message */}
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm flex items-start gap-3 animate-pulse">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 border border-[#e0e0e0] hover:bg-[#f9f9f9] text-[#333] font-medium py-3 rounded-xl text-sm transition disabled:opacity-50 disabled:cursor-not-allowed mb-6 bg-white hover:border-[#d0d0d0] active:bg-[#f5f5f5]"
          >
            {isLoading ? (
              <>
          ...
          <form onSubmit={handleSignUp} className="space-y-4" noValidate>
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-semibold text-[#333] mb-2.5">
                Telefon (İsteğe Bağlı)
              </label>
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#8f8f8f]" />
                <input
                  id="phone"
                  type="tel"
                  value={phone}
