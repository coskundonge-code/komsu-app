...
export default function BusinessError({ error, reset }: ErrorProps) {
  useEffect(() => {
    reportClientError(error, { boundary: 'business-error' });
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="text-center max-w-lg mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Ä°Åletme Paneli HatasÄ±</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            <Home size={20} />
            <span>Ä°Åletme Paneline DÃ¶n</span>
          </Link>
        </div>
      </div>
    </div>
