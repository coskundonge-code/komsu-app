    ...
    <div className="min-h-screen bg-background">
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="p-3 bg-primary-light rounded-lg border border-[#a7dbb8]">
                  <div className="flex items-center gap-2 mb-1">
                    <TrendingUp size={16} className="text-primary" />
                    <p className="text-xs text-text-muted">Dönüşüm</p>
                  </div>
                  <p className="text-lg font-bold text-text-primary">
              ...
              <div className="flex gap-2 border-t border-border pt-4">
                {campaign.status === 'active' && (
                  <>
                    <button className="flex-1 flex items-center justify-center gap-2 bg-primary-light hover:bg-primary-light text-primary-hover font-medium py-2 px-3 rounded-lg transition-colors text-sm">
                      <Edit2 size={16} />
                      Düzenle
                    </button>
                ...
                {campaign.status === 'ended' && (
                  <>
                    ...
                    <button className="flex-1 flex items-center justify-center gap-2 bg-background hover:bg-[#e0e0e0] text-text-primary font-medium py-2 px-3 rounded-lg transition-colors text-sm">
                      <Download size={16} />
                      Rapor
                    </button>
                  </>
      ...
      {filteredCampaigns.length === 0 && (
        <div className="bg-surface rounded-lg border border-border p-12 text-center">
          ...
          <p className="text-text-muted mt-2 mb-4">Yeni bir reklam kampanyası başlatarak işletmenizi daha fazla kişiye ulaştırın</p>
          <button
            onClick={() => setShowAddForm(true)}
